DROP DATABASE IF EXISTS SpotifyClone;
  ...
  CREATE TABLE SpotifyClone.artistas(
      ...
      nome_artista VARCHAR(35) NOT NULL
  ) engine = InnoDB;
  ...
  CREATE TABLE SpotifyClone.follow_artistas(
  ...
  CREATE TABLE SpotifyClone.history_reproducoes(
  ...
  INSERT INTO SpotifyClone.follow_artistas (usuario_id, artista_id)
  VALUES
    (1, 1),
    (1, 2),
    (1, 3),
  ...
  INSERT INTO SpotifyClone.history_reproducoes (data_reproducao, musica_id, usuario_id)
  VALUES
